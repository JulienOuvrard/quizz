...
IriSP.Widgets.Controller.prototype.template =
    ...
    + '<button class="Ldt-Ctrl-Quizz-Create-Button" ><img src="../widgets/img/buzz.svg" title="Ajouter une réponse" style="width:30px;height:30px; margin: -5px 18px 0;"></button>'
    + '</div>'
    + '</div>'
