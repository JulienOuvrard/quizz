...
IriSP.Widgets.QuizzCreator.prototype.nbAnswers = function(){
	var numItems = $('.Ldt-QuizzCreator-Questions-Answer').length;
	return numItems;
};
...
IriSP.Widgets.QuizzCreator.prototype.removeAnswer = function() {
	$("body").on("click", ".Ldt-QuizzCreator-Remove", function() {
		var id = this.id;
		$("#"+ id).closest(".Ldt-QuizzCreator-Questions-Answer").remove();
	});
};
...
IriSP.Widgets.QuizzCreator.prototype.addQuestion = function(annotation, number) {
	...
	for (i = 0; i < answers.length; i++) {
		output += '<div class="Ldt-QuizzCreator-Questions-Answer">'
		+	'<div class="Ldt-QuizzCreator-Questions-Answer-Correct">'+ this.question.renderFullTemplate(answers[i], this.nbAnswers()) +'</div>'
		+ 	'<div class="Ldt-QuizzCreator-Questions-Answer-Content">Réponse :<br />'
...
IriSP.Widgets.QuizzCreator.prototype.onQuestionAdd = function(e) {
	...
	var output = '<div class="Ldt-QuizzCreator-Questions-Answer">'
